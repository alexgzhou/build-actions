...
uci set system.@system[0].hostname='OpenWrt-XiaomiR4A'                            # 修改主机名称为OpenWrt-XiaomiR4A
...
sed -i "s/Xiaomi Mi Router 4A Gigabit Edition/Xiaomi Mi Router 4A Gigabit Edition by Alex/g" target/linux/ramips/dts/mt7621_xiaomi_mi-router-4a-gigabit.dts
